...
public class AIActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Msg msg = new Msg("您好，我是智能医疗助手！您有什么健康问题吗？可以向我提问哟！（如：沙眼应该用什么药？)\n当然您也可以发送舌苔照片来进行辅助诊断哟~", Msg.TYPE_RECEIVED);
...
//                msgListView.setSelection(data.size());
                ...
                if (Build.VERSION.SDK_INT < 24) {
                    ...
                    popupWindow.showAtLocation(view, Gravity.NO_GRAVITY, 0, location[1] + view.getHeight() + 0);
                }
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.camera_item:
                        ...
                        Uri uri = null;
                        if (Build.VERSION.SDK_INT >= 24) {
                            uri = FileProvider.getUriForFile(AIActivity.this, "com.sourcey.intelligentmedicalsystem.provider", out);
                        } else {
